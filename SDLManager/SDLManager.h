...
class SDLManager
{
	...
	int plotPixel (int xCoord, int yCoord, Uint8 r, Uint8 g, Uint8 b, Uint8 a);
	...
	// Sound Routines
	//****************************************************************************
	void playSound(const std::string &rcSoundLocation, bool bLoop);
	bool isSoundPlaying() const;
	void setSoundPause(bool bState);
	void stopSound();
